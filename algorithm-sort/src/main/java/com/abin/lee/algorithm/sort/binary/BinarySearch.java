package com.abin.lee.algorithm.sort.binary;
...
public class BinarySearch {
    public static void main(String[] args) {
        ...
        int binaryRecursive = binaryRecursive(input, 0, input.length - 1, 4);
        System.out.println("binaryRecursive=" + binaryRecursive);
        int binaryLoop = binaryLoop(input, 0, input.length - 1, 4);
        System.out.println("binaryLoop=" + binaryLoop);
    }
